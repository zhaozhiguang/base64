package com.zhaozhiguang.component.base64;
...
public class Base64Util extends BaseNCodec {
    ...
    public Base64Util(int lineLength, byte[] lineSeparator, boolean urlSafe) {
        ...
        if (lineSeparator != null) {
            if (this.containsAlphabetOrPad(lineSeparator)) {
                String sep = lineSeparator==null?null:new String(lineSeparator,Charset.forName("UTF-8"));
    ...
    public static boolean isBase64(String base64) {
        return isBase64(base64==null?null:base64.getBytes(Charset.forName("UTF-8")));
    }
    ...
    public static String encodeBase64String(byte[] binaryData) {
        return encodeBase64(binaryData, false)==null?null:new String(encodeBase64(binaryData, false),Charset.forName("UTF-8"));
    }
    ...
    public static String encodeBase64URLSafeString(byte[] binaryData) {
        return encodeBase64(binaryData, false, true)==null?null:new String(encodeBase64(binaryData, false, true),Charset.forName("UTF-8"));
    }
