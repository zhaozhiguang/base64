...
public abstract class BaseNCodec {
    ...
    public String encodeToString(byte[] pArray) {
        return this.encode(pArray)==null?null:new String(pArray,Charset.forName("UTF-8"));
    }
    ...
    public byte[] decode(String pArray) {
        return this.decode(pArray==null?null:pArray.getBytes(Charset.forName("UTF-8")));
    }
    ...
    public boolean isInAlphabet(String basen) {
        return this.isInAlphabet(basen==null?null:basen.getBytes(Charset.forName("UTF-8")), true);
    }
